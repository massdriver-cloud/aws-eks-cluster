...
To download a `kubeconfig` file for your cluster, navigate to the `kubernetes-cluster` resource that was created by the bundle (either via the instance sidebar, or the resources page), and select download.
